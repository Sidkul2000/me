        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/temp.jpeg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">ITSA</a></h1>
              <span className="email"><i className="icon-mail"></i> itsapvg@gmail.com</span>
            </div>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#about" data-nav-section="ourleaders">Our Leaders</a></li>
                  <li><a href="#about" data-nav-section="ourteams">Our Teams</a></li>
